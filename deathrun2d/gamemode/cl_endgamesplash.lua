...
PANEL.SubTitles[ TEAM_RUNNERS ] = {"Eat lead, brainmunchers",
...
PANEL.SubTitles[ TEAM_KILLERS ] = {"Eat shit, brainhavers",
"Humanity is no more...",
...
PANEL.WinVoice[ TEAM_RUNNERS ] = Sound("vo/coast/odessa/male01/nlo_cheer02.wav")
PANEL.WinVoice[ TEAM_KILLERS ] = Sound("vo/npc/male01/no01.wav")
...
function PANEL:Think()
	...
	elseif ( self.DrawTime < CurTime() ) then
		...
		elseif not self.lblLord and IsValid( self.ZombieKing ) then
			...
			if self.Team == TEAM_KILLERS then
